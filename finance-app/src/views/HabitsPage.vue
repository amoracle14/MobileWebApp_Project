      ...
      <div class="main-content-container">
        ...
        <ion-card class="categories-card">
          <ion-card-content>
            ...
            <p class="chart-note">
              หมวด "อาหารและเครื่องดื่ม" มีสัดส่วนรายจ่ายสูงสุด
            </p>
          </ion-card-content>
        </ion-card>
        ...
        <ion-card class="persona-card">
          <ion-card-header>
            <ion-card-title>
              <ion-icon :icon="sparkles" class="ai-icon"></ion-icon>
          ...
          <ion-card-content>
            ...
            <p class="persona-desc">
              "ตรวจพบรายจ่ายในหมวดอาหารสูงกว่าเกณฑ์ปกติในระยะนี้
              แนะนำให้ควบคุมงบประมาณเพื่อรักษาสภาพคล่องและบรรลุเป้าหมายทางการเงินที่ตั้งไว้"
            </p>
